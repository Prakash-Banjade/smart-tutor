...
const conversations = [
  ...
  },
  {
    ...
    lastMessage: 'Shall we schedule for next week?',
    timestamp: 'Yesterday',
    unread: 1,
    online: true
  }
...
const messages = [
  ...
  },
  {
    id: 2,
    senderId: 'me',
    text: 'I have some questions about the last calculus problem we discussed.',
    timestamp: '2:26 PM'
  },
  {
    id: 3,
    senderId: 1,
    text: 'Of course! Which part would you like me to clarify?',
    timestamp: '2:28 PM'
  },
  {
    id: 4,
    senderId: 'me',
    text: 'The integration by parts section. I\'m still having trouble understanding when to use it.',
    timestamp: '2:29 PM'
  },
  {
    id: 5,
      ...
      <div className="w-80 border-r border-gray-200 bg-white">
        ...
        <div className="overflow-y-auto h-full">
          {conversations.map((conversation) => (
            <div
              key={conversation.id}
              className={`p-4 cursor-pointer hover:bg-gray-50 ${selectedChat === conversation.id ? 'bg-blue-50' : ''
                }`}
          ...
          <>
            ...
            <div className="flex-1 overflow-y-auto p-4">
              {messages.map((message) => (
                ...
                >
                  <div
                    className={`max-w-lg rounded-lg px-4 py-2 ${message.senderId === 'me'
